...
// Pastikan sesi ada dan role adalah admin, jika tidak, redirect ke halaman login
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="index_admin.php?page=data_dokter" class="nav-link">
              <i class="nav-icon fas fa-chain"></i>
              <p>
                Dokter
                <span class="right badge badge-danger">Admin</span>
              </p>
          ...
          <li class="nav-item">
            <a href="index_admin.php?page=dataa_pasien" class="nav-link">
