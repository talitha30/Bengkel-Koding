...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form role="form" method="post" action="../auth_tambah_obat.php">
              <div class="box-body">
            ...
            <div class="box-body table-responsive">
              <table id="obat" class="table table-bordered table-hover">
                ...
                $no=0;
                $query=mysqli_query($koneksi,"SELECT * FROM obat ORDER BY id DESC");
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="../../hapus_obat.php?id=<?=$row['id'];?>" class="btn btn-danger" role="button" title="Hapus Data"><i class="glyphicon glyphicon-trash"></i>Hapus</a>
                  </td>
                </tr>
